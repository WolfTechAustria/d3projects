...
<html>
	<head>
		...
		<title>Projektmanagement | Kundenübersicht</title>
        ...
        <script type="text/javascript" src="/js/intern/customer_functions.js"></script>
	</head>
	<body class="loggedin">
		...
		<div class="content">                           <!-- hier gehts los -->
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <button id="opn_ModalCreateCustomer" class="btn btn-info">Kunden anlegen</button>

                    <br><br>
                    <table id="customerTable" class="table display responsive nowrap" width="100%">
                        <thead>
                    ...
                    <?php include "../include/modal_addCustomer.php"?>
                </div>            
            </div>
			<?php include '../include/footer.php'; ?>
		</div>
	</body>
    <script type="text/javascript" src="/js/intern/customer_modal.js"></script>
</html>
